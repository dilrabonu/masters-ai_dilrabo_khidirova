...
def preprocess_and_display_data():
    ...
    try:
        ...
        preprocessor = DataPreprocessor(os.getenv("DATA_PATH", 'heart_attack_youngesters_india.csv'))
        
        # Validate input data
        if not os.path.exists(preprocessor.file_path):
            raise FileNotFoundError("Data file is missing or not accessible")
