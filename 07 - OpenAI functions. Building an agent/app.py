...
MODEL = "gpt-4o"
DATABASE = "/mnt/data/unique_animals.db"
USER_MESSAGE = "Hi, what are the names and speeds of animals with a height greater than 1 meter?"
...
Table: animals_info
Columns: Name, Kingdom, Phylum, Subphylum, Class, Order, Suborder, Family, Genus, Species, Top_speed, Weight, Height, Length, Attributes, Distribution, Habits, Diet, Mating_Habits, Population
"""
